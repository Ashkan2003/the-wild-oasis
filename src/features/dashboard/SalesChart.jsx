...
import {
  ...
  XAxis,
  YAxis,
} from "recharts"; // npm i recharts@2 // we use this library to show a beutiful chart in dashbord-page
...
function SalesChart({ bookings, numDays }) {
  ...
  const allDates = eachDayOfInterval({
    // whit  eachDayOfInterval-functions we sliced the date in to days in format of an Array of obj(day) from the startDate to endDate
    start: subDays(new Date(), numDays - 1), //the subDays is a helper function fo minese the dates that we npm i the library // "new Date()" is the todays date - numDays -1
    end: new Date(),
  });
